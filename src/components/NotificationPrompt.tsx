...
export const NotificationPrompt = forwardRef<HTMLDivElement, NotificationPromptProps>(
  ({ permission, onRequestPermission, onRefreshPermission }, ref) => {
        ...
        <Card ref={ref} className="border-emerald-200 bg-emerald-50/50 dark:border-emerald-800 dark:bg-emerald-950/30">
          <CardContent className="flex items-center justify-between gap-4 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="font-medium text-emerald-900 dark:text-emerald-100">Notifications enabled</p>
    ...
    if (permission === 'denied') {
      return (
        <Card ref={ref} className="border-muted bg-muted/30">
          <CardContent className="flex items-center justify-between gap-4 p-4">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-muted-foreground">
                  Enable them in your browser settings, then click Refresh
                </p>
              </div>
            </div>
            <Button variant="outline" size="sm" onClick={onRefreshPermission}>
